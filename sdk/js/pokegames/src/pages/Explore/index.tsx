...
import { LSClient, LSUser, LSServerError } from "lightswitch-js-sdk";
...
const Explore = () => {
  ...
  console.log(lightswitch.getBooleanFlag("qwe", user, true));
  console.log(lightswitch.getIntegerFlag("JS-Test", user, 300));
